  ...
  return (
    <div className="backdrop-blur-md bg-black/40 border-b border-white/10 sticky top-[60px] md:top-[70px] z-10">
      <div className="container mx-auto px-2 md:px-4">
        <nav className="flex overflow-x-auto scrollbar-thin pb-1 md:pb-2">
          {navItems.map((item) => (
            <NavLink
              key={item.label}
              to={item.path}
              ...
              className={({ isActive }) =>
                `flex items-center px-2 md:px-4 py-2 md:py-3 text-xs md:text-sm font-medium whitespace-nowrap transition-colors ${
                  isActive
